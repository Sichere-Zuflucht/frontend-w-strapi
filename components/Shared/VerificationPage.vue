<template>
	<div v-if="userdata" class="pa-3">
		<div v-if="!success && userdata.verification == 'false'">
			...
			<p>
				Da häusliche Gewalt ein sehr sensibles Thema ist, möchten wir Sie kennen
				lernen, um Sichere Zuflucht zu einem sicheren Raum zu machen. Deshalb
				nehmen wir in den nächsten Tagen über die unten angegebenen
				Informationen Kontakt mit Ihnen auf, um mehr über Sie zu erfahren und
