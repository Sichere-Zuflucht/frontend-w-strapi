      ...
      steps: [
        {
          ...
          text:
            'Um mit der beratenden Person Kontakt aufzunehmen, registriert sich die Frau auf unserer Plattform.',
          btn: 'Registrieren',
        ...
        },
        {
          ...
          title: '3. Bezahlen',
          text:
            'Der/die Berater*in schickt der Frau 3 Terminvorschläge. Mit der Annahme eines Termins bezahlt die Frau die Beratung.',
        },
        {
          icon: 'mdi-calendar-check',
          title: '4. Loslegen',
          text:
            'Nach der Bezahlung steht der Zugang zur online Beratung für den gewünschten Termin im eingeloggten Bereich zur Verfügung.',
        },
      ],
    }
  },
