<template>
	<v-container>
		...
		<div>
			...
			<h2>
				<strong
					>Registrierung und Auftragsabwicklung auf unserer Webseite</strong
				>
			</h2>
			<h3>
				<strong>Art und Zweck der Verarbeitung:</strong>
			...
			<p>
				...
				Zur Abwicklung von Bestellungen (einschließlich Zahlungsabwicklung und
				ggf. Bonitätsprüfung), zur Zusendung von Werbung durch uns sowie für den
				Kundenservice. <br />
				Eine Übermittlung Ihrer personenbezogenen Daten an Dritte erfolgt nur,
				sofern die Weitergabe im Rahmen der Vertragsabwicklung oder zu
				Abrechnungs- oder Inkassozwecken erforderlich ist (bspw.
			...
			<p>
				...
				<a href="http://www.google.com/privacypolicy.html"
					>den Google-Datenschutzhinweisen</a
				>
