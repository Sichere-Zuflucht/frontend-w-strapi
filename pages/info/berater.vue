	...
	<div>
		...
		><v-container class="py-16">
			...
			<v-row
				><v-col cols="12" sm="6">
					<h3
						class="text-h4 primary--text text-uppercase py-4 font-weight-bold"
					>
						Jede 3. Frau
					</h3>
		...
		<v-container>
			...
			<div style="max-width: 600px" class="mx-auto">
				...
				<p>
					Sie können gewaltbetroffenen Frauen helfen, ihr Selbstwertgefühl zu
					stärken und ihr Leben wieder in die eigene Hand zu nehmen. Eine
					Möglichkeit kann sein, ihnen beizubringen, ihre Stärken und
					Fähigkeiten zu erkennen und sie bei der Suche nach neuen Berufs- und
					Bildungsmöglichkeiten zu unterstützen. Wenn Sie Frauen beraten wollen,
					damit sie ihren eigenen Weg finden können, freuen wir uns, Sie als
					Coach auf Sichere Zuflucht begrüßen zu können.
				</p>
				<p class="font-weight-bold mb-2 mt-8">Psychosoziale Beratung</p>
				<p>
					Haben Sie Erfahrungen in der Beratung von gewaltbetroffen Frauen oder
					Frauenspezifischen Themen? Kennen Sie die Grundmuster von
					Partnerschaftsgewalt und Gewaltdynamiken? Sind sie aufgrund ihres
					beruflichen Hintergrundes in der Lage misshandelte Frauen zu
					unterstützen sich aus ihrer Situation zu befreien? Dann bieten Sie
					gern Ihr Know-How für eine von Ihnen bestimmte Stundenzahl auf Sichere
					Zuflucht an. Wir sind froh, Sie dabei zu haben.
				</p>
				<p class="font-weight-bold mb-2 mt-8">Rechtsberatung</p>
				<p>
					Sind sie Anwalt/Anwältin im Bereich Familienrecht? Sie haben Erfahrung
					mit der Abwicklung von Trennungen und den damit einhergehenden
					Verbindlichkeiten? Wir würden uns freuen, Ihre juristische Kompetenz
					als Unterstützung für gewaltbetroffene Frauen anbieten zu können.
					Legen Sie sich gern direkt ein Profil an. Sie können die Zeiten, die
					Sie zur Beratung anbieten frei wählen.
				</p>
			</div>
		</v-container>
		<v-sheet color="grey lighten-5"
				...
				><v-row
					><v-col cols="12" md="5">
						...
						<div class="caption">
							...
							<nuxt-link to="/faq"
								>Weitere Antworten zu diesem Thema in unseren FAQ</nuxt-link
							>
						</div>
					</v-col>
					<v-col cols="12" md="7">
		...
		<v-sheet color="grey lighten-5 pt-8">
			<v-container class="text-center">
				<h3
					class="text-h4 text-uppercase secondary--text font-weight-bold mb-1"
				>
