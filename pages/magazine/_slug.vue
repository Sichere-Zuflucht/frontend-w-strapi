		...
		<UtilsBanner
			:url="
				functionalCookieAccepted
					...
					: false
			"
			:icon="!functionalCookieAccepted ? 'mdi-cookie-alert' : false"
			:strapiImg="functionalCookieAccepted"
		/>
	...
	export default {
		data() {
			return {
				...
				altText:
					'Bitte akzeptiere die funktionalen Cookies, um Video- und Audiobeiträge laden zu können.',
			};
		},
		async mounted() {
		...
		computed: {
			...
			altImg() {
				return location.href + 'cookie-alert.png';
			},
			cssVars() {
				return {
