<template>
  <div>
    ...
    <v-sheet color="grey lighten-5 py-md-16"><v-container>
        <v-row><v-col cols="12" md="6" class="text-center text-md-right">
            <h3 class="text-uppercase mb-4 secondary--text text-h1">
              <span style="font-size: 2.5em; line-height: 1em">Wir<br />helfen<br />dir!</span>
            </h3>
          ...
          <v-col cols="12" md="6">
            <v-card class="mx-auto" max-width="320">
              ...
              <v-card-title class="text-h3 secondary--text font-weight-bold mb-2">Beratung und Hilfe
              </v-card-title>

              <v-card-subtitle>
                Hier kannst du dich <b>online beraten lassen</b>, wenn du von häuslicher Gewalt betroffen bist. Ganz
                <b>einfach, sicher und anonym</b> von überall aus, mit dem <b>Handy</b>.
    ...
    <v-container class="pt-md-16">
      <h3 class="text-h3 text-md-h1 text-uppercase text-center secondary--text pt-8" style="font-weight: bold">
        Sichere Zuflucht-Magazin
      </h3>
    </v-container>
    <MagazineSlider v-if="magazineList" :list="magazineList" :change="true" />
      ...
      <v-row style="max-width: 700px" class="mx-auto">
        <v-col cols="12" md="6" class="text-center text-md-right">
          ...
          <p>
            ...
            <br /><b>- Psychosoziale Beratung <br />- Rechtsberatung <br />-
              Coaching</b>
          </p>
        </v-col>
        <v-col cols="12" md="6">
        ...
        <v-col cols="12" md="6" style="display: none">
          <v-card class="mx-auto" max-width="320">
            <v-img src="gleren-meneghin-VSLPOL9PwB8-unsplash.jpg" height="200px"></v-img>

            <v-card-title class="text-h3 primary--text font-weight-bold mb-2">Liebe Unterkunfsbesitzer*innen, helfen Sie
              mit!
            </v-card-title>

            <v-card-subtitle>
              Vermieten Sie Ihr Ferienhaus, -wohnung, -bungalow was auch immer –
              neben der touristischen Vermietung und helfen Sie so aktiv mit,
              Frauen und Kinder aus Gewaltsituationen heraus zu holen. Wir
              freuen uns auch besonders über dauerhafte Angebote wie
              Mietwohnungen.
              <v-btn color="primary my-4" href="mailto:kontakt@sichere-zuflucht.de">
